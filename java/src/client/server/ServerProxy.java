...
public class ServerProxy implements IServer {
     ...
     * @post1. The server returns an HTTP 400 error response, and the body contains an error  message.
     */
    @Override
     ...
     * @post If !free, lose the required resources.  The road is now on the map in the correct location.
     * @post And longest road has been applied, if applicable.
     */
    @Override
     ...
     * @post Player gain(s) victory point(s).
     */
    @Override
