...
public class OldDevCards {
     ...
     * @param roadBuilding
     */
    public OldDevCards(String monopoly, String monument, String roadBuilding, String soldier, String yearOfPlenty) {
    ...
    public OldDevCards withMonopoly(String monopoly) {
        this.monopoly = monopoly;
        return this;
    }
    ...
    public OldDevCards withMonument(String monument) {
        this.monument = monument;
        return this;
    }
    ...
    public OldDevCards withRoadBuilding(String roadBuilding) {
        this.roadBuilding = roadBuilding;
        return this;
    }
    ...
    public OldDevCards withSoldier(String soldier) {
        this.soldier = soldier;
        return this;
    }
    ...
    public OldDevCards withYearOfPlenty(String yearOfPlenty) {
        this.yearOfPlenty = yearOfPlenty;
        return this;
    }
