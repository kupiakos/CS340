...
public class BuildingFacadeTest {
    ...
    public void testBuildRoad() {
        ...
        assertTrue(facade.canBuildRoad(player, new EdgeLocation(new HexLocation(1, -1), EdgeDirection.North), true, false));
        facade.buildRoad(player, new EdgeLocation(new HexLocation(1, -1), EdgeDirection.North), true, false);
        assertTrue(facade.getTotalRoadsBuilt(player) == 3);
        assertTrue(player.getRoads() == 0);
        player.setResources(new ResourceSet(0, 2, 0, 1, 0));
        assertFalse(facade.canBuildRoad(player, new EdgeLocation(new HexLocation(0, 0), EdgeDirection.NorthWest), false, false));
        player.setRoads(1);
        assertTrue(facade.canBuildRoad(player, new EdgeLocation(new HexLocation(0, 0), EdgeDirection.NorthWest), false, false));
        facade.buildRoad(player, new EdgeLocation(new HexLocation(0, 0), EdgeDirection.NorthWest), false, false);
        assertFalse(facade.canBuildRoad(player, new EdgeLocation(new HexLocation(0, 0), EdgeDirection.NorthWest), false, false));
